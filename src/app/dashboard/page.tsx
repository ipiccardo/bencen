      ...
      <div className={classes.homePageContainer}>
        ...
        <div className={classes.firstSectionContainer}>
          <section>
            ...
            >
              <div className={classes.showHeaderParagraphContainer}>
                ...
                <p>
                  Welcome to Bencen, where innovation meets excellence in
                  construction and services.
                </p>
                <p>
                  Our digital space is a portal into our values, built on a
              ...
              <div className={classes.containerAbsolute}>
                <div className={classes.aboutCardContainer}>
                  ...
                  <div className={classes.aboutUsParagraphContainer}>
                    <h1>ABOUT US</h1>
                    <p>
                      All Bencen, we are more than builders, we are creators of
                      spaces that imspire. Our journey in the realm of
                      construction has been fueled by a passion for excellence.
                    </p>
                    <p>
                      From the drawing board to the final brick, we meticulously
                      craft every project to reflect innovation, quality, and
                      client aspirations. Join us in shaping a world where
              ...
              <div className={classes.containerAbsolute}>
                <div className={classes.clientCardContainer}>
                  ...
                  <div className={classes.clientParagraphContainer}>
                    ...
                    <p>
                      Our commitment to excellence and unwavering dedication
                      have enabled us to build lasting relationships with
                      individuals and businesses alike. Our track record of
                      delivering exceptional service has not only met but
                      exceeded the expectations of our valued clients.
                    </p>
                    <p>
                      Their satisfaction is a testament to our expertise,
                      reliability, and a deep-rooted commitment to their
                      success.
                    </p>
                    <Button
                      href={""}
            ...
            <div className={`${classes.imageContainer} ${classes.otherImage}`}>
              <div className={classes.containerAbsolute}>
                <div className={classes.contactContainer}>
                  <h1>CONTACT</h1>
                  <p>
                    Have questions or interested in collaborating with us? We
                    {`'`}d love to hear from you! Our team is ready to assist
                    you.
                  </p>
                  <p>
                    Click the {`'`}Contact Us{`'`} button below to get in touch.
                    Whether you{`'`}re looking for information, exploring
                    partnership opportunities, or want to join our team, we{`'`}
                    re here to help. Your inquiry is important to us, and we
                    {`'`}ll respond promptly. Let{`'`}s connect and make great
          ...
          <section className={classes.sixSectionContainer}>
            <div className={`${classes.imageContainer} ${classes.otherImage}`}>
              <div className={classes.containerAbsolute}>
                <div className={`${classes.newsContainer} newsContainer`}>
                  <h1>LATEST NEWS</h1>
                  <NewsCard />
                </div>
              </div>
